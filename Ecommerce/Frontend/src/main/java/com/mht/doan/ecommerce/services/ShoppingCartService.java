...
import com.mht.doan.ecommerce.dtos.CartItemDto;
import com.mht.doan.ecommerce.dtos.ProductDto;
import com.mht.doan.ecommerce.dtos.ShoppingCartDto;
...
import com.mht.doan.ecommerce.repositories.CartItemRepository;
import com.mht.doan.ecommerce.repositories.ShoppingCartRepository;
...
public class ShoppingCartService {
    ...
    public void deleteCartById(int id) {
        ShoppingCart shoppingCart = cartRepository.findById(id).get();
